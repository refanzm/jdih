    ...
    <body class="antialiased">
            <div style="align-items: center" class="row">
                    <div class="col-md-auto" style="margin-left: 5px">
                        <a href="{{ url('/') }}"><img src="{{ asset('images/jdihn.png') }}" style="width: 70px"></a>
                    </div>
                    ...
                    <div class="col-md-auto" style="margin-top: 5px; margin-right: 10px">
                        <a href="https://batukota.go.id/"><img src="{{ asset('images/pemkotbatu.png') }}" style="width: 70px"></a>
                    </div>
            </div>
            <div class="row">
            ...
            <div style="background-color: black">
                <p class="text-body-primary" style="color: red">
                    Holla
                </p>
            </div>
